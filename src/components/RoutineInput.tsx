...
const RoutineInput: React.FC<RoutineInputProps> = ({ onAnalyze, isLoading }) => {
  ...
  return (
    <div className="fixed bottom-24 left-6 right-6 z-40 animate-in slide-in-from-bottom-4 duration-500">
      <div className="bg-[#1a1a1e]/95 backdrop-blur-3xl border border-white/10 rounded-[2.5rem] p-4 shadow-[0_30px_60px_-12px_rgba(0,0,0,0.8)] group relative overflow-hidden">
        ...
        <div className="relative flex items-center space-x-4 pl-3">
          ...
          <button
            ...
            className="w-14 h-14 flex-shrink-0 bg-cyan-500 text-black rounded-[1.5rem] flex items-center justify-center hover:scale-105 active:scale-95 transition-all disabled:opacity-20 disabled:scale-100 shadow-xl shadow-cyan-500/30"
          >
