...
const RoutineInput: React.FC<RoutineInputProps> = ({ onAnalyze, isLoading, language = 'en' }) => {
  ...
  return (
    <div className="fixed bottom-28 left-6 right-6 md:left-1/2 md:right-auto md:-translate-x-1/2 md:w-full md:max-w-2xl z-40 animate-in slide-in-from-bottom-4 duration-500">
