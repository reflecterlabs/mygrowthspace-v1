  ...
  return (
    <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-500/20 rounded-[2rem] p-6 mb-6 animate-in slide-in-from-top duration-500">
      ...
      <div className="flex gap-3">
        <button 
          onClick={() => onAccept(suggestion.payload)}
          className="flex-1 bg-cyan-500 text-black py-3 rounded-2xl font-black text-xs uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-cyan-400 transition-all"
        >
